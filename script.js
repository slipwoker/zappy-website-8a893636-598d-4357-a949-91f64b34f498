    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משרד עורכי דין טליה ברזאני משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
        ...
        function initContactForm() {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: '8a893636-598d-4357-a949-91f64b34f498',
                        name: data.name,
                        email: data.email,
